    ...
    static get styles() {
      return ct.LitCSS`
        ...
        #searchText {
          ...
          --mdc-text-field-outline-color: rgba(255,255,255,0.10);
          --mdc-text-field-hover-outline-color: rgba(255,255,255,0.18);
          --mdc-text-field-focused-outline-color: rgba(255,255,255,0.22);
